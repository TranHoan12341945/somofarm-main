...
export function Destaques() {
  return (
    <div id="destaques" className="bg-light-green-100 w-full py-10">
      <div className="container flex flex-col-reverse items-center justify-between max-w-6xl gap-10 px-4 mx-auto md:flex-row">
        <div className="flex flex-col justify-between h-full gap-4 md:w-1/2">
          ...
          <a
            href="https://somofarmcuulong.somogroup.vn/gioi-thieu/"
        ...
        <div className="flex flex-col items-center w-auto">
          <img src={image} alt="" className="rounded-lg transform transition-transform duration-300 hover:scale-105" style={{ width: '90%', height: 'auto', maxHeight: '450px' }} />
        </div>
      </div>
    </div>
  );
