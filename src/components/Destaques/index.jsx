      ...
      <div className="container flex flex-col-reverse items-center justify-between max-w-6xl gap-10 px-4 py-10 mx-auto md:flex-row">
        <div className="flex flex-col justify-between h-full gap-4 md:w-1/2">
          <div className="flex flex-col gap-4 flex-grow">
            <h3 className="text-sm font-medium text-gray-700">Resort cao cấp bậc nhất</h3>
            <h2 className="text-2xl font-medium" style={{ color: '#1d3260', fontFamily: 'Arial, sans-serif' }}>NÂNG NIU TRẢI NGHIỆM NGHỈ DƯỠNG</h2>
            <p className="text-sm font-medium text-gray-700">Đôi nét về chúng tôi</p>
          ...
          <button className="flex items-center justify-center gap-2 px-5 py-3 mt-3 font-bold bg-orange-500 rounded hover:bg-orange-600">
            About Us
        ...
        <div className="relative flex flex-col items-center w-auto">
          <img src={image} alt="" className="rounded-lg transform transition-transform duration-300 hover:scale-105 shadow-lg border-4 border-white" style={{ width: '90%', height: 'auto', maxHeight: '450px' }} />
        </div>
      </div>
    </div>
  );
